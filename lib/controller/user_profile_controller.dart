...
// final Rx<String> _changedName = Rx<String>{()};
  ...
  getUserDat() async {
    ...
    String name =
        userData.containsKey('userName') ? userData['userName'] : 'DefaultName';
  ...
  Future<void> changeUserName(String changedName) async {
    await FirebaseFirestore.instance
        .collection('users')
        .doc(FirebaseAuth.instance.currentUser!.uid)
        .update({
    ...
    _user.value.update('name', (value) => changedName);
     update();
  }
}
